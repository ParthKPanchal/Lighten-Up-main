    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          <button class="nav-link fw-semibold px-3" id="accountDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="border: none; background: transparent;">
            Shop <i class="fa-solid fa-chevron-down"></i>
          </button>
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="accountDropdown">
            <!-- For all the type of user -->
            <li><a class="dropdown-item" href="shop.php">View all product</a></li>

            <!-- For all the registered user -->
            <?php if($user_id != '') { ?>
