...
if(isset($_POST['update_product'])) {
  ...
  $update_product = $conn->prepare("UPDATE `products` SET product_name = ?, product_price = ?, color = ?, size = ?, product_brand = ?, product_material = ?, product_manufacturer = ?, available = ?, rated = ?, installation = ?, warranty = ? WHERE id = ?");
  $update_product->execute([$product_name, $product_price, $color, $size, $product_brand, $product_material, $product_manufacturer, $available, $rated, $installation, $warranty, $update_id]);
