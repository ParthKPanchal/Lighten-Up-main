...
if (isset($_POST['add_product'])) {
  ...
  if(isset($_POST['warranty'])){
   ...
   if($image_01_size > 2000000){
      ...
      $insert_product = $conn->prepare("INSERT INTO `products`(id, user_id, product_name, product_price, color, size, product_brand, product_material, product_manufacturer, available, rated, installation, warranty, image_01, image_02, image_03) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_product->execute([$id, $user_id, $product_name, $product_price, $color, $size, $product_brand, $product_material, $product_manufacturer, $available, $rated, $installation, $warranty, $rename_image_01, $rename_image_02, $rename_image_03]);
